...
open class OutputProviderImpl(
    ...
    fun resolve(): Map<String, Jar> {
        project.logger.lifecycle("${project.path} Resolved output steps")
        return sequence.last().resolve()
    }
    ...
    private fun afterEvaluate() {
        ...
        project.logger.lifecycle("Resolving output steps")
