...
data class McpExecutor(
    ...
    private fun getStepLogic(type: String): StepLogic {
        return when (type) {
            ...
            "downloadClient" -> StepLogic.NoOpWithFile { minecraftProvider.minecraftDownloader.getMinecraft(EnvType.CLIENT) }
            "downloadServer" -> StepLogic.NoOpWithFile { minecraftProvider.minecraftDownloader.getMinecraft(EnvType.SERVER) }
...
//            "strip" -> StepLogic.NoOp()
            ...
            "downloadClientMappings" -> StepLogic.DownloadManifestFile(
                minecraftProvider.minecraftDownloader.metadata.downloads["client_mappings"]!!
            )

            "downloadServerMappings" -> StepLogic.DownloadManifestFile(
                minecraftProvider.minecraftDownloader.metadata.downloads["server_mappings"]!!
            )
