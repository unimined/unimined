...
/**
 */
public final class Tiny2FileWriter2 implements MappingWriter {
	public Tiny2FileWriter2(Writer writer, boolean escapeNames) {
		this.writer = writer;
	...
	public boolean visitField(String srcName, @Nullable String srcDesc) throws IOException {
		write("\tf\t");
		if (srcDesc != null) writeName(srcDesc);
		writeTab();
		writeName(srcName);
